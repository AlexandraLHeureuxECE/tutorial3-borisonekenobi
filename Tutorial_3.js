...
let cleanData = function (dataset)
{
    ...
    for (let data of dataset /* complete this part*/) // this loop iterates over the elements of the array
    {
        ...
        for (let prop  data) // This loop iterates over the properties of each object pick appropriate type
        {
            /**
...
function printData() // this function doesn't take any argument
{
    ...
    console.log(`temperature = ${/* Refers to the temperature property*/} , precipitation = ${/* Refers to the temperature property*/} , humidity = ${/* Refers to the temperature property*/}, numProp=${/*DO NOT CHANGE*/Object.keys(this).length}`)
}
